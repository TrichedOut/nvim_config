return {
  ...
  config = function()
    ...
    keymap.set("n", "H", "<Plug>(cokeline-focus-prev)", { desc = "Focus previous buffer" })
    keymap.set("n", "L", "<Plug>(cokeline-focus-next)", { desc = "Focus next buffer" })
    keymap.set("n", "X", "<Plug>(cokeline-pick-close)", { desc = "Pick close" })
